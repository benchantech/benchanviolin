...
const ROUTES = [
  ...
  },
  {
    ...
    priority: 99,
    exact: [
      "my bow changes make a bump or accent",
  ...
  },
  {
    ...
    priority: 102,
    exact: [
      "string crossing", "string crossings",
  ...
  },
  {
    ...
    priority: 107,
    exact: [
      "my double stops sound wrong even when each note seems right",
  ...
  },
  {
    ...
    priority: 97,
    exact: [
      "my high-position intonation is unreliable",
  ...
  },
  {
    ...
    priority: 100,
    exact: [
      "i cannot tell whether i am sharp or flat",
  ...
  },
  {
    ...
    priority: 200,
    exact: [
      "my bridge soundpost or instrument setup may be unsafe",
      "my bridge, soundpost, or instrument setup may be unsafe",
